...
var StyledLogoWithTextIcon$1 = styled__default['default'].img(templateObject_1$s || (templateObject_1$s = __makeTemplateObject(["\n  margin-left: 16px;\n  margin-right: 32px;\n"], ["\n  margin-left: 16px;\n  margin-right: 32px;\n"])));
var Icon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default['default'].createElement(StyledLogoWithTextIcon$1, { width: "128px", height: "128px", src: "images/logo.svg" })));
};
var templateObject_1$s;
...
var StyledLogoWithTextIcon = styled__default['default'].img(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  margin-left: 16px;\n  margin-right: 32px;\n  height: 48px;\n"], ["\n  margin-left: 16px;\n  margin-right: 32px;\n  height: 48px;\n"])));
var Logo = function (_a) {
    _a.isDark; var href = _a.href;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(StyledLogo, { className: "mobile-icon", src: "/images/logo.svg" }),
        React__default['default'].createElement(StyledLogoWithTextIcon, { className: "desktop-icon", src: "/images/logoWithText.svg" })));
